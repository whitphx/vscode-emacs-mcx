  ...
  suite("cursors are in the blanks", () => {
    const cursorPositionsLinst: Array<Array<[number, number]>> = [
      [
        [1, 0],
        [7, 0],
      ], // At the beginning of each blanks
      [
        [3, 0],
        [9, 0],
      ], // At the middle of each blanks
      [
        [5, 0],
        [11, 0],
  ...
  suite("cursors are at the beginning or the middle of non-empty lines", () => {
    const cursorPositionsLinst: Array<Array<[number, number]>> = [
      ...
      [
        [0, 5],
        [0, 5],
      ], // At the middle of the first non-empty line
      [
        [6, 0],
        [6, 0],
      ], // At the beginning of the second non-empty line
      [
        [6, 5],
        [6, 5],
      ], // At the middle of the second non-empty line
      [
        [12, 0],
        [12, 0],
      ], // At the beginning of the last non-empty line
      [
        [12, 5],
        [12, 5],
