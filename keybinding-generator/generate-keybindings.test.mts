  ...
  it("converts src with shiftVariants", () => {
    ...
    const expected: KeyBinding[] = [
      ...
      },
      {
        key: "shift+ctrl+d",
        command: "emacs-mcx.forwardChar",
        when: "editorTextFocus && config.emacs-mcx.enableShiftSelection",
  ...
  it("converts src with shiftVariants and isearchInterruptible", () => {
    ...
    const expected: KeyBinding[] = [
      ...
      },
      {
        key: "shift+ctrl+n",
        command: "emacs-mcx.isearchExit",
        when: "!config.emacs-mcx.cursorMoveOnFindWidget && editorFocus && findWidgetVisible && !replaceInputFocussed && !isComposing && config.emacs-mcx.enableShiftSelection",
